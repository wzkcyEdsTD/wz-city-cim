const CenterPoint = {
    destination: {
        x: -2872828.083485288,
        y: 4845861.78424895,
        z: 2993927.3715711846
    },
    orientation: {
        heading: 0,
        pitch: -0.5125697843108954,
        roll: 0
    },
}
const CenterPoint2D = {
    destination: {
        x: -2873531.3508397187,
        y: 4847100.583783348,
        z: 2997294.6321514845
    }, orientation: {
        heading: 0,
...
export {
    generateCurve, getIndexPoints, CenterPoint, CenterPoint2D, LeftPoint, RightPoint, centerPosition, dirPosition
}