  ...
  methods: {
    ...
    initForceTreeTopic() {
      ...
      if (this.forceTreeTopic.length) {
        ...
        const forceNode2rd = this.forceTreeTopic[1];
        this.SetForceTrueTopicLabelId(forceNode.id);
        this.SetForceTrueTopicLabels([forceNode.id, forceNode2rd.id]);
        this.nodeCheckChange(forceNode, true, true);
        forceNode2rd && this.nodeCheckChange(forceNode2rd, true, true);
      } else {
