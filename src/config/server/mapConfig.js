...
const _GRID_SOURCE_HOST_WG_ = "http://10.36.234.83:8090/iserver/services/map-xzqh1222/rest/maps/";
export const ServiceUrl = {
  ...
  GridSource: [{
    ...
    children: [{
      ...
      return {
        ...v,
        url: (v.id == "pxswg" ? _GRID_SOURCE_HOST_WG_ : _GRID_SOURCE_HOST_OTHER_) + v.id
      }
    })
  }, {
    label: "经济技术开发区",
    children: [{
      ...
      return {
        ...v,
        url: _GRID_SOURCE_HOST_ + v.label
      }
    })
  }],
  //  wmts 2.5d
  ...
  // 全市域地形
  YJDem: "https://ditu.wzcitybrain.com/iserver/services/3D-mongodb-DEMLC/rest/realspace/datas/DEM_LC",
  // mvt矢量服务
  YJMVT: "https://ditu.wzcitybrain.com/iserver/services/map-mongodbMvt-XZQH3Q/restjsr/v1/vectortile/maps/XZQH_3Q",
...
export const ExtraSourceURL = {
  S1: "https://ditu.wzcitybrain.com/iserver/services/3D-mongodb-S1/rest/realspace/datas/S1/config",
};


export const BimSourceURL = {
  SCENE_URL: "http://172.20.83.223:8098/iserver/services/3D-Placement_house_0728/rest/realspace",
  SCENE_DATA_URL: "http://172.20.83.223:8098/iserver/services/data-Placement_house_0728/rest/data",
  SCENE_SQL_URL: "http://172.20.83.223:8098/iserver/services/data-SW_Data/rest/data/featureResults.rjson?returnContent=true",
  STATION_SCENE_URL: "http://172.20.83.223:8098/iserver/services/3D-Airport_Station/rest/realspace",
  STATION_DATA_URL: "http://172.20.83.223:8098/iserver/services/data-Airport_Station/rest/data",
  UNDERGROUND_SCENE_URL: "http://172.20.83.223:8098/iserver/services/3D-GSLINE/rest/realspace"
};
